...
<head>
    ...
    <style>
        ...
        .status { display: inline-block; padding: 5px 15px; background-color: #10b981; color: white; border-radius: 20px; font-weight: bold; }
    </style>
</head>
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Good news! Your borrow request has been <strong style="color: #059669;">APPROVED</strong> by the library administrator.</p>
            ...
            <div class="details">
                <table>
                    ...
                    <tr>
                        <td>Status</td>
                        <td><span class="status">Approved - Ready to Borrow</span></td>
                    </tr>
                </table>
            </div>

            <p><strong>Important:</strong> Please pick up the book from the library before the due date. Late returns may incur penalties.</p>
