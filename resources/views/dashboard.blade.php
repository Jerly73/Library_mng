        ...
        <main class="flex-1 p-6">
            ...
            <section class="mt-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                    ...
                    @foreach([
                        ['img'=>'book1.jpg','title'=>'Business Ethics'],
                        ['img'=>'book2.jpg','title'=>'Design'],
                        ['img'=>'book3.jpg','title'=>'Investment'],
                        ['img'=>'momo.jpg','title'=>'Horror']
                    ] as $book)

                    <div class=" w-45 h-64 bg-white p-4 rounded-xl shadow text-center">
                        ...
                        <div class="flex justify-center space-x-2">
                            <a class="bg-blue-500 text-white text-xs px-3 py-2 rounded cursor-pointer hover:bg-blue-600">
                                Borrow
                                </a>
                            <a href="availability" class="bg-yellow-400 text-white text-xs px-3 py-2 rounded cursor-pointer hover:bg-yellow-500">
                                Availability
                            </a>
                        </div>
                    </div>
